...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public PostViewHolder(final View itemView) {
        ...
        appreciate = (ImageView)itemView.findViewById(R.id.appreciate);
        setAuthorid = (TextView)itemView.findViewById(R.id.author_id);
        pointsid = (TextView)itemView.findViewById(R.id.final_value);
        setAuthorid.setVisibility(View.GONE);
        ...
        appreciate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("loggg", "onClick:" + setAuthorid.getText());

                Log.e("longest", "" + pointsid.getText());
                 int finalvalue = Integer.parseInt(pointsid.getText().toString()) + 5;

                mDatabase.child("people").child(String.valueOf(setAuthorid.getText())).child("points").setValue(finalvalue);
                Log.e("final value",""+finalvalue);
//                Log.e("old",old);
//                int finalvalue = Integer.parseInt(old) + 5;
//                Log.e("Value", String.valueOf(finalvalue));
//
////
////                Log.e("Oldest",""+old);
//
////                FirebaseUtil.getPeopleRef().child(String.valueOf(setAuthorid.getText())).child("points").setValue(longest).addOnSuccessListener((Activity) itemView.getContext(), new OnSuccessListener<Void>() {
////                    @Override
////                    public void onSuccess(Void aVoid) {
////                        Log.e("Successfullll", "" + aVoid.toString());
////                    }
////                });
    ...
    public void setPointsinView(String authorid){
        FirebaseUtil.getPeopleRef().child(String.valueOf(authorid)).child("points").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(final DataSnapshot dataSnapshot) {

                String old = dataSnapshot.getValue().toString();
                if (old != null){
                    pointsid.setText(old);
                }
            }
